...
import certification as certification
...
def PrivateChatReport(udid, phoneNumber, extractedData):
    ...
    for chat in extractedData:
        ...
        if chat['ZMESSAGETYPE'] == 1:
            ...
            mediaType = 4
            message_width = c.stringWidth(chat["contactName"], 'Helvetica', 12)
            message_box_width = message_width + 52
            ...
            message_box_width = message_width + 52
        elif chat['ZMESSAGETYPE'] == 39:  # Video 1 time view
            mediaType = 39
            message_width = c.stringWidth(utils.ConvertSeconds(chat['duration']), 'Helvetica', 12)
            message_box_width = message_width + 52
        ...
        if previousSender != chat['user']:
            if chat['user'] is not None:
                ...
                if chat['contactName'] is not None:
                    c.drawString(x_offset, y_offset, chat['contactName'] + " - " + "(" + utils.FormatPhoneNumberForPageTables(chat['user']) + ")")
                else:
        ...
        if mediaType == 1:
            ...
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, chat["contactName"])
            y_offset -= 16
        elif mediaType == 5:
    ...
    # Certificate the output report
    certificatedReportZip = certification.CertificateReportAndZipFiles(udid, buffer.getvalue(), globalConstants.PrivateChat, phoneNumber)
...
def GroupChatReport(udid, groupName, extractedData):

    groupNameSinglewords = groupName.split()
    groupNameNoSpaces = ''.join(groupNameSinglewords)
    ...
    for chat in extractedData:
        ...
        if chat['ZMESSAGETYPE'] == 1:
            ...
            mediaType = 4
            message_width = c.stringWidth(chat["vcardContactName"], 'Helvetica', 12)
            message_box_width = message_width + 52
        elif chat['ZMESSAGETYPE'] == 5:
            mediaType = 5
            message_width = c.stringWidth(str(chat['latitude']) + " , " + str(chat["longitude"]), 'Helvetica', 12)
        ...
        if mediaType == 1:
            c.drawImage(basePath + "/assets/img/icons/CameraNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/CameraUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            y_offset -= 16
        elif mediaType == 2:
            ...
            c.drawImage(basePath + "/assets/img/icons/MicNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/MicUser.png", x_offset + 14,
                        y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, utils.ConvertSeconds(chat['duration']))
            y_offset -= 16
        elif mediaType == 4:
            c.drawImage(basePath + "/assets/img/icons/ContactNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/ContactUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, chat["vcardContactName"])
            y_offset -= 16
        elif mediaType == 5:
            c.drawImage(basePath + "/assets/img/icons/PositionNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/PositionUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6,
                         str(chat['latitude']) + " , " + str(chat["longitude"]))
            ...
            c.drawImage(basePath + "/assets/img/icons/GroupNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/GroupUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            y_offset -= 16
        elif mediaType == 7:
            c.drawImage(basePath + "/assets/img/icons/LinkNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/LinkUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            y_offset -= 16
        elif mediaType == 8:
            c.drawImage(basePath + "/assets/img/icons/DocNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/DocUser.png", x_offset + 14,
                        y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            if chat["text"] != 'None':
                c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, chat['text'])
            ...
            c.drawImage(basePath + "/assets/img/icons/GifNum.png" if chat['user'] == 'Database owner' else basePath + "/assets/img/icons/GifUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, "GIF")
            y_offset -= 16
        elif mediaType == 14:
            c.drawImage(basePath + "/assets/img/icons/BinNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/BinUser.png", x_offset + 14,
                        y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, globalConstants.DeletedMessageInChatReport)
            y_offset -= 16
        elif mediaType == 15:
            c.drawImage(basePath + "/assets/img/icons/StickerNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/StickerUser.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, "Sticker")
            y_offset -= 16
        elif mediaType == 38:
            c.drawImage(basePath + "/assets/img/icons/OneTimeNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/OneTimeUSer.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, "Image")
            y_offset -= 16
            ...
            c.drawImage(basePath + "/assets/img/icons/PollNum.png" if chat['user'] is not None else basePath + "/assets/img/icons/PollUSer.png",
                        x_offset + 14, y_offset + message_box_height / 2 - 7, width=12, height=12)
            mediaType = -1
            c.drawString(x_offset + 32, y_offset + message_box_height / 2 - 6, "Poll")
            y_offset -= 16
    ...
    # Move buffer to initial position
    buffer.seek(0)
    print("before certificatedReportZip")
    # Certificate the output report
    certificatedReportZip = certification.CertificateReportAndZipFiles(udid, buffer.getvalue(), globalConstants.GroupChat, None, groupNameNoSpaces)
    print("before buffer.close()")
    buffer.close()
    print("before return")
    # Return generated file
    return certificatedReportZip
